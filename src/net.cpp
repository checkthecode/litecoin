...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Greececoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"greececointools.com", "124.182.5.93"},
    {"greececoinpool.org", "162.250.125.26"}
};

static const char *strTestNetDNSSeed[][2] = {
    {"greececointools.com", "testnet-seed.greececointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Greececoin is probably already running."), addrBind.ToString().c_str());
        else
